...
public class DataParserTest {
  ...
  public void parseTransactionalPortfolio() {
    ...
    String transactionalString = "TYPE : TRANSACTIONAL\n" +
            ...
            "PURCHASES : \n" +
            "Stock Symbol : GOOG,Quantity : 10.0,Date of Purchase : 2022-10-24,Commission Fee : 100.0\n" +
            "Stock Symbol : AAPL,Quantity : 10.0,Date of Purchase : 2022-11-01,Commission Fee : 10.0\n" +
            "SALE : \n" +
            "Stock Symbol : AAPL,Quantity : 5.0,Date of Purchase : 2022-11-01,Commission Fee : 10.0\n" +
            "------ END ------\n";
